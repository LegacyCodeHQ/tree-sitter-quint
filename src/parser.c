...
enum ts_symbol_identifiers {
  ...
  sym_identifier = 38,
  sym_source_file = 39,
  sym_module_definition = 40,
  sym__declaration = 41,
  sym_constant_declaration = 42,
  sym_variable_declaration = 43,
  sym_value_definition = 44,
  sym_type_alias_declaration = 45,
  sym_uninterpreted_type_declaration = 46,
  sym__type = 47,
  ...
  sym_name_reference = 63,
  aux_sym_source_file_repeat1 = 64,
  aux_sym_module_definition_repeat1 = 65,
  aux_sym_tuple_type_repeat1 = 66,
  aux_sym_record_type_repeat1 = 67,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value_definition, 4, 0, 4),
  ...
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 15),
